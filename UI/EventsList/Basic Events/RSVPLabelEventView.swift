...
struct RSVPLabelEventView: View {
    
    let inGroupError:Bool
    @Binding var rsvpEvents : [RSVPEvents]
                                                            ...
                                                            VStack{
                                                                ...
                                                                HStack{
                                                                    Button {
                                                                        ...
                                                                        Text("View alliances attending (\(events[event].totalRSVP!))")
                                                                            .padding(5)
                                                                            .background(RoundedRectangle(cornerRadius:10).fill( LinearGradient(gradient: Gradient(colors: [ AppColor.lovolPinkish,AppColor.lovolDarkPurple]), startPoint: .top, endPoint: .bottom)))
