...
struct AllianceOnly: View {
    ...
    var body: some View {
        HStack{
            ...
            VStack{
                Spacer()
                Text("This event will only show up for your alliances.")                .font(.custom("Rubik Regular", size: 16)).foregroundColor(.white)
                Spacer()
                Button {
...
struct AllianceOnly_Previews: PreviewProvider {
